 ...
 * @author HP
 */
@WebServlet(urlPatterns = {"/ReistrationServlet"})
public class ReistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                int i = stmt.executeUpdate("INSERT INTO public.\"Registration\"(firstname, lastname, username, password) VALUES ('"+_firstname+"','"+ _lastname+"','"+ _username+"','" + _password +"');");
                out.println(i);
                connection.close();
